...
//        String segBaseName = baseDir + data + "/" + data + "Seg-";
        String segBaseName = baseDir + data + "/" + "simulated_15f-";
        String rawBaseName = baseDir + data + "/" + "simulated_15f-";
        
        DataSet dataset = new DataSet("simulated_15f", 15);
        String fs = File.separator;
        dataset.setDirRaw(baseDir + data + fs);
        dataset.setDirSeg(baseDir + data + fs);
        dataset.setBaseRaw("simulated_15f-");
        dataset.setBaseSeg("simulated_15f-");
        ...
        // are still merging together after this pealgorithmriod of frames, the merging association is 
...
//        algorithm.analyseSplitting(baseDir + data + "/TRACK/res_split.txt",false);
        algorithm.challengeFormat(baseDir + data + "/res_track.txt", minLife);
        algorithm.analyseSplitting(baseDir + data + "/res_split.txt",false);
