...
public class AssociationMinDistance extends AssociationSeeker {
	...
	public AssociationMinDistance(TemporalPopulation temporalObject, AssociatedObjectList associatedList) {
		super(associatedList, temporalObject, EventType.ASSOCIATION);
	}
	...
	public void execute() {
		...
		this.associations = findShortestDistance(leftSourceObject3DList, leftTargetObject3DList, matrix);
	...
	private AssociatedObjectList findShortestDistance(List<ObjectTree> source, List<ObjectTree> target, CostMatrix matrix) {
