...
SET(_MYLIB_HINTS
  ...
  ${PROJECT_SOURCE_DIR}/external/mylib
)
...
#Some path variables
if(MSVC OR XCODE)
  set(_DEBUG_HINTS   build/Debug build/MY_TIFF/Debug)
  set(_RELEASE_HINTS build/RelWithDebInfo build/MY_TIFF/RelWithDebInfo)
else()
...
#TODO: ask Nathan for new CMakeList.txt that builds mytiff.lib. Checkk all the commneted out stuff
#myfft
...
SET(MYLIB_LIBRARIES ${MYLIB_MYLIB_LIBRARY} ${MYLIB_MYTIFF_LIBRARY} )	
